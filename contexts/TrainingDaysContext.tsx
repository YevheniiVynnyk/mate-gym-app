...
const TrainingDaysContext = createContext<TrainingDaysContextProps | undefined>(
  undefined,
);

export const TrainingDaysProvider: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {
...
export const useTrainingDays = () => {
  ...
  if (!context)
    throw new Error("useTrainingDays must be used within TrainingDaysProvider");
  return context;
};
