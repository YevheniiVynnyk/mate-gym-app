        ...
        <ScrollView className="flex-1 my-2" showsVerticalScrollIndicator={false}>
            ...
            <View className="my-6 p-2">
                ...
                <View className="flex-row flex-wrap justify-between">
                    <ActionCard icon={<Plus size={24} color="#22c55e"/>} label="Новая" onPress={router.toCreateTrainingDay}/>
                    <ActionCard icon={<Calendar size={24} color="#22c55e"/>} label="Мои" onPress={router.toTrainingList}/>
