    ...
    <ScrollView className="flex-1 bg-white p-4">
      ...
      <View className="items-center mb-5">
        ...
        <Text className="text-center text-gray-500 my-2">
          Если вам нравится приложение Mate Gym и вы хотите поддержать его
          развитие, вы можете это сделать любым удобным способом.
        </Text>
      ...
      <View className="bg-gray-50 p-4 rounded-xl my-2">
        ...
        <View className="mt-3">
          <Text className="bg-gray-200 px-2 py-1 rounded-md mb-1 w-fit">
            React Developer
          </Text>
          <Text className="bg-gray-200 px-2 py-1 rounded-md mb-1 w-fit">
            TypeScript
          </Text>
          <Text className="bg-gray-200 px-2 py-1 rounded-md mb-2 w-fit">
            Mobile Apps
          </Text>
          <Text className="text-gray-500">
            Специализируюсь на создании современных веб и мобильных приложений.
            Mate Gym — проект для помощи тренерам и клиентам в достижении
            фитнес-целей.
          </Text>
        </View>
      </View>
