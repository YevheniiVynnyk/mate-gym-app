...
const TrainingPlansForm: React.FC = () => {
    ...
    const filteredPlans = trainingPlans.filter((plan) => {
        ...
        const matchesEquipment = !selectedEquipment || plan.equipmentType === selectedEquipment;
    ...
    return (
        <ScrollView className="flex-1 bg-white p-4">
            ...
            {/* Результаты */}
            <Text className="text-gray-600 mb-2">Найдено планов: {filteredPlans.length}</Text>
