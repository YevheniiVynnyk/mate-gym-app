              ...
              <ScrollView showsVerticalScrollIndicator>
                ...
                <View className="pb-5">
                  ...
                  <Text className="text-sm text-gray-700 mt-1 leading-5">
                    ...
                    между администрацией приложения Mate Gym и пользователем при
                  ...
                  <Text className="text-sm text-gray-700 mt-1 leading-5">
                    ...
                    планировать тренировки, отслеживать прогресс и
                  ...
                  <Text className="text-sm text-gray-700 mt-1 leading-5 ml-2">
                    ...
                    конфиденциальность данных других пользователей
                  </Text>
                  ...
                  <Text className="text-sm text-gray-700 mt-1 leading-5">
                    Администрация обязуется не разглашать персональные данные
                  ...
                  <Text className="text-sm text-gray-700 mt-1 leading-5">
                    ...
                    своих учетных данных и все действия, совершенные под его
                    аккаунтом.
                  </Text>
                  ...
                  <Text className="text-sm text-gray-700 mt-1 leading-5">
                    Администрация имеет право изменять условия соглашения с
