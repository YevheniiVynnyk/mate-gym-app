...
import { PrivacyContent, privacyService } from "@/services/privacyService";
        ...
        <View className="bg-white rounded-lg max-w-lg w-full max-h-[80%] p-6">
            ...
            {isLoading ? (
              ...
              <View className="space-y-4">
                <Text className="text-xs text-gray-400 mb-4">
                  {t("privacy.version")} {privacyContent.version} |{" "}
                  {t("privacy.published")}{" "}
          ...
          <View className="flex-row justify-end space-x-3">
            ...
            <Button onPress={handleAccept} disabled={isAccepting}>
              {isAccepting
                ? t("privacy.accepting") || "Принимаю..."
                : t("privacy.accept") || "Принять"}
            </Button>
          </View>
