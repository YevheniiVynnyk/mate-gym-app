...
// ===== Trigger =====
export const SelectTrigger: React.FC<{ onPress: () => void }> = ({
  children,
  onPress,
}) => (
  <TouchableOpacity
...
// ===== Value =====
export const SelectValue: React.FC = ({ children }) => (
...
// ===== Scroll Buttons =====
export const SelectScrollUpButton: React.FC<{ onPress: () => void }> = ({
  onPress,
}) => (
...
export const SelectScrollDownButton: React.FC<{ onPress: () => void }> = ({
  onPress,
}) => (
  <TouchableOpacity onPress={onPress} className="flex items-center py-1">
    <ChevronDown size={20} />
