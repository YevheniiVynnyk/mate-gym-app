                        ...
                        <StyledView className="space-y-6">
                            ...
                            >
                                <Text className="text-sm text-gray-600 leading-relaxed">
                                    ...
                                    приложения Mate Gym. Используя наше приложение, вы соглашаетесь
                            ...
                            >
                                <Text className="text-sm text-gray-600">
                                    Мы собираем данные: имя, email, телефон, параметры тела и данные
                                    тренировок.
                                </Text>
                            </Section>
                            ...
                            >
                                <Text className="text-sm text-gray-600">
                                    Вы имеете право получать информацию, исправлять или удалять ваши
                                    персональные данные.
                                </Text>
                            </Section>
