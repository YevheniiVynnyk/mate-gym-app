...
import {Database, Eye, FileText, Lock, Shield, Users, X} from "lucide-react-native";
						...
						<StyledView className="space-y-6">
							...
							<Section icon={<FileText className="h-5 w-5 text-blue-500"/>} title="1. Общие положения">
								<Text className="text-sm text-gray-600 leading-relaxed">
									...
									мобильного приложения Mate Gym. Используя наше приложение, вы соглашаетесь с
									условиями данной политики.
								</Text>
							</Section>

							<Section icon={<Database className="h-5 w-5 text-blue-500"/>}
							...
							<Section icon={<Lock className="h-5 w-5 text-blue-500"/>}
									 title="3. Защита персональных данных">
								<Text className="text-sm text-gray-600">
									Мы используем шифрование, резервное копирование и ограничение доступа для защиты
									ваших данных.
								</Text>
							</Section>
							...
							<Section icon={<Users className="h-5 w-5 text-blue-500"/>} title="4. Права пользователей">
								<Text className="text-sm text-gray-600">
									Вы имеете право получать информацию, исправлять или удалять ваши персональные
									данные.
								</Text>
							</Section>
							...
							<Section title="6. Передача данных третьим лицам">
								<Text className="text-sm text-gray-600">
									Мы не передаем ваши данные третьим лицам без согласия, за исключением законных
									требований.
								</Text>
							</Section>
