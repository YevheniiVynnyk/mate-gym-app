      ...
      <StyledView className="flex-1 bg-black/50 justify-center items-center">
        <StyledView className="bg-white rounded-lg max-h-[90%] w-[90%] p-4">
          ...
          <StyledText className="text-sm text-gray-600 mb-2">
            Условия использования приложения Mate Gym и обработки персональных
            данных
          </StyledText>
            ...
            <StyledView className="space-y-6">
              ...
              >
                <Text className="text-sm text-gray-600 leading-relaxed">
                  ...
                  обработки и защиты информации о пользователях мобильного
                  приложения Mate Gym. Используя наше приложение, вы
              ...
              >
                <Text className="text-sm text-gray-600">
                  Мы собираем данные: имя, email, телефон, параметры тела и
                  данные тренировок.
                </Text>
              </Section>
              ...
              <Section
                ...
                title="3. Защита персональных данных"
              >
                <Text className="text-sm text-gray-600">
                  Мы используем шифрование, резервное копирование и ограничение
                  доступа для защиты ваших данных.
                </Text>
              </Section>
              ...
              >
                <Text className="text-sm text-gray-600">
                  Вы имеете право получать информацию, исправлять или удалять
              ...
              >
                <Text className="text-sm text-gray-600">
                  Мы используем cookies для улучшения функциональности и
              ...
              <Section title="6. Передача данных третьим лицам">
                <Text className="text-sm text-gray-600">
                  Мы не передаем ваши данные третьим лицам без согласия, за
                  исключением законных требований.
                </Text>
              </Section>

              <Section title="7. Изменения в политике">
                <Text className="text-sm text-gray-600">
                  Мы можем обновлять политику и уведомлять пользователей через
                  приложение или email.
                </Text>
              </Section>
